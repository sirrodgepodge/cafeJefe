...
}, titleTop = Math.ceil($landing.outerHeight()), contactTop = .92 * Math.ceil($contact.offset().top), downAnimReached = .395 * titleTop + 4.5;
...
var listeners = function() {
    ...
    var pagePos = 0, titleFixed = !1, landingHeadDimmed = !1, topTextShowing = !0, contactPopped = !1, landingScroll = function() {
        ...
        $placeHolder.toggleClass("no-show"), titleFixed = !titleFixed), console.log("contactTop", contactTop), 
        console.log("contactPopped", contactPopped), (pagePos >= contactTop && !contactPopped || contactTop > pagePos && contactPopped) && ($contact.toggleClass("poppin"), 
